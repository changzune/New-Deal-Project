	...
	function viewEmpDtl(loginID){
	   ...
	   function viewEmpDtlResult(data){
	      if(data.result == "SUCCESS"){
	         ...
	         $('#loginID2').val(data.empDtl.loginID);
	         $('#name2').val(data.empDtl.name);
	         selectComCombo("dept", "dept_cd2", "sel", "", data.empDtl.dept_cd);
...
<form id="myForm" action=""  method="">
			...
			<ul>
				...
				<li class="contents">
					...
					<div class="content">
						...
						<p class="conTitle">
							<span><a href="/employee/empGrade.do">승진내역 조회</a></span> <span class="fr"> 
						</p>
						<table style="margin-bottom : 10px; border: 1px #e2e6ed; border-style:solid !important;" height = "50px" width="100%" align="left">
                     	...
                     	<span class="fr">
							<p class="Location">
								...
								<input type="date" id="from_date" style = "width : 30%;">&nbsp~&nbsp<input type="date" id="to_date" style = "width : 30%;">
	...
	<form id="empDetail">
		...
		<div id="layer1" class="layerPosition layerPop layerType2"
			...
			<dl>
			<dt>
               <strong id="maybe">사원 상세정보</strong>
            </dt>
					...
					<table class="row">
						...
						<tbody>
							<tr>
								...
								<td><input type="text" class="inputTxt p100" name="loginID2"
									id="loginID2" readonly /></td>
								<th scope="row">사원명<span class="font_red">*</span></th>
								<td><input type="text" class="inputTxt p100" name="name2"
									id="name2" /></td>
							</tr>
							<tr>
					...
					<table class="row" style="margin-top: 0.5%;">
						...
						<tbody>
							<tr>
								...
								<td><select id="dept_cd2" name="dept_cd" style="width: 65%;"></select>
								</td>
