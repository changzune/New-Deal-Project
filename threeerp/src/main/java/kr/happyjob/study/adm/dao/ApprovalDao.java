...
public interface ApprovalDao {
	...
	// 신고서 목록 리스트 조회
	public List<ApprovalModel> listApproval(Map<String, Object> paramMap);
	
	// 신고서 목록 카운트 조회
	public int approvalCnt(Map<String,Object> paramMap) throws Exception;
	
	// 신고서 상세 조회
	public ApprovalModel listApprovalDtl(Map<String, Object> paramMap);
	...
	// 수리업 신고서 조회
	public ApprovalModel medicalRepairDtl(Map<String, Object> paramMap);
